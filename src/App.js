...
function App() {
    ...
    return (_jsxs("div", { className: "App", children: [_jsx(Navbar, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsxs(_Fragment, { children: [_jsx("div", { className: "home-video-section", children: _jsx(HomeSectionVideo, { pageName: "Accueil" }) }), _jsx(Biographie1, {}), _jsx(SwiperGallery, { pageName: "Accueil" }), _jsx(VideoPlayer, {}), _jsx(Biographie2, {}), _jsx(ReviewWidget, { pageName: "Accueil" })] }) }), _jsx(Route, { path: "/nos-valeurs/", element: _jsx(NosValeurs, {}) }), _jsx(Route, { path: "/nos-valeurs", element: _jsx(Navigate, { to: "/nos-valeurs/", replace: true }) }), _jsx(Route, { path: "/carte/", element: _jsx(Carte, {}) }), _jsx(Route, { path: "/carte", element: _jsx(Navigate, { to: "/carte/", replace: true }) }), _jsx(Route, { path: "/recrutement/", element: _jsx(Recrutement, {}) }), _jsx(Route, { path: "/recrutement", element: _jsx(Navigate, { to: "/recrutement/", replace: true }) }), _jsx(Route, { path: "/contact/", element: _jsx(Contact, {}) }), _jsx(Route, { path: "/contact", element: _jsx(Navigate, { to: "/contact/", replace: true }) }), _jsx(Route, { path: "*", element: _jsx(Page404, {}) })] }), _jsx(Footer, {}), _jsx(CookieManager, {})] }));
}
export default App;
