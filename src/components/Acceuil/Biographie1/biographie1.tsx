...
const Biographie1: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Restaurant Italien Ambiance Street Art | 150 Places & Terrasse | Rosi
          Trattoria Brive
        </title>
        <meta
          name="description"
          content="Restaurant italien atypique à Brive avec décoration Street Art. 50 places intérieures intimistes et 100 places en terrasse. Pizzas napolitaines dans un cadre chaleureux et élégant."
        />
        <meta
          name="keywords"
          content="restaurant italien Brive, décoration street art, terrasse restaurant, pizzas napolitaines, cadre atypique, restaurant chaleureux, réservation restaurant"
        />
        <meta
          property="og:title"
          content="Restaurant Italien Street Art & Terrasse | Rosi Trattoria Brive"
        />
        <meta
          property="og:description"
          content="Découvrez notre restaurant italien au décor Street Art unique. 150 places entre intérieur intime et grande terrasse pour savourer nos pizzas napolitaines."
        />
        <link
          rel="canonical"
          href="https://www.rosi-trattoria.com/#ambiance-restaurant"
        />
      </Helmet>
        ...
        <div className="biographie__container">
          ...
          <AnimatedSection animationType="fade-in-scale" delay={150}>
            <div className="biographie__section-header">
              <div
                className="biographie__subtitle-container"
                aria-hidden="true"
              >
          ...
          <AnimatedSection animationType="fade-in-scale" delay={200}>
            <div className="biographie__description">
              <p className="biographie__text">
                ...
                <br />
                La <strong>décoration Street Art</strong> procure un sentiment
                de dépaysement total. <em>Spacieux mais intime</em>, le cadre
                est parfait pour passer des moments de détente et de
                tranquillité.
              </p>
            </div>
          </AnimatedSection>
